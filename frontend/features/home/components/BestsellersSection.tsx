    ...
    <section className="py-12 sm:py-16">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader 
          ...
          title="Bestsellers" 
          viewAllLink="/products?sortBy=price_desc"
        />
        ...
        {isLoading ? (
          ...
          <div className="w-full flex flex-col items-center justify-center p-10 bg-danger/10 rounded-2xl border border-danger/20">
            <div className="text-danger font-bold text-xl mb-2">Failed to load bestsellers</div>
          ...
          <div className="w-full flex justify-center py-20 bg-muted rounded-2xl border border-border">
            <p className="text-muted-foreground font-medium">No bestsellers found.</p>
          </div>
        ) : (
